...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang="ru">
      <head>
        <title>LUX ON VIP</title>
        <meta name="description" content="LUX ON VIP" />
        ...
        <meta name="apple-mobile-web-app-title" content="LUX ON VIP" />
