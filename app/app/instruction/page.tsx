...
export default function InstructionPage() {
  ...
  const translations = {
    ru: {
      ...
      depositSubtitle: 'Как пополнить баланс в букмекере',
      depositSteps: [
        {
          number: '1',
          title: 'Выбор букмекера',
          description: 'Выберите букмекер из списка: 1XBET, 1WIN, MELBET, MOSTBET, WINWIN, 888STARZ'
        },
        {
          number: '2',
          title: 'Ввод ID игрока',
          description: 'Введите ваш ID игрока в букмекере. ID можно найти в личном кабинете букмекера'
        },
        {
          number: '3',
      ...
      withdrawSubtitle: 'Как вывести средства с баланса букмекера',
      withdrawSteps: [
        {
          number: '1',
          title: 'Выбор букмекера',
          description: 'Выберите букмекер, с баланса которого хотите вывести средства'
        },
        {
          number: '2',
          title: 'Выбор банка',
