...
export default function InstructionPage() {
  ...
  const translations = {
    ru: {
      ...
      depositSubtitle: 'Как пополнить баланс',
      depositSteps: [
        {
          number: '1',
          title: 'Выбор счета',
          description: 'Выберите счет из списка: 1XBET, 1WIN, MELBET, MOSTBET, WINWIN, 888STARZ'
        },
        {
          number: '2',
          title: 'Ввод ID игрока',
          description: 'Введите ваш ID игрока. ID можно найти в личном кабинете'
        },
        {
          number: '3',
      ...
      withdrawSubtitle: 'Как вывести средства с баланса',
      withdrawSteps: [
        {
          number: '1',
          title: 'Выбор счета',
          description: 'Выберите счет, с баланса которого хотите вывести средства'
        },
        {
          number: '2',
          title: 'Выбор банка',
        ...
        },
        {
          ...
          description: 'Введите код подтверждения с сайта'
        },
        {
          number: '6',
          title: 'Ожидание',
