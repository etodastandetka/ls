      ...
      <section className="card space-y-2">
          ...
          <div className="relative">
            ...
            <label 
              ...
              className="flex flex-col items-center justify-center w-full h-24 border-2 border-dashed border-green-400/30 rounded-xl bg-gradient-to-br from-green-900/20 to-green-800/30 hover:border-green-400/50 hover:bg-green-800/40 transition-all duration-300 cursor-pointer group relative"
            >
              <div className="flex flex-col items-center space-y-2">
                <div className="w-7 h-7 rounded-full bg-green-500/20 flex items-center justify-center group-hover:bg-green-500/30 transition-colors">
          ...
          {receiptPreview && (
            <div className="mt-3 p-3 bg-black/20 rounded-xl border border-green-400/20">
              <div className="text-center mb-2">
                <span className="text-xs text-green-400 font-medium">Предварительный просмотр:</span>
              </div>
