...
export default function FaqPage(){
  ...
  const translations = {
    ru: {
      ...
      depositAnswer: 'Перейдите в раздел «Пополнение», выберите счет, введите ID и сумму, затем выберите банк и следуйте инструкциям.',
      withdrawQuestion: 'Как сделать вывод?',
      withdrawAnswer: 'Откройте «Вывод», выберите счет и банк, укажите телефон, код с сайта и подтвердите заявку.',
      ...
      limitsAnswer: 'Минимальная сумма пополнения: 35 сом, максимальная: 500,000 сом. Минимальная сумма вывода: 100 сом, без ограничений.',
    ...
    en: {
      ...
      limitsAnswer: 'Minimum deposit: 35 som, maximum: 500,000 som. Minimum withdrawal: 100 som, no limit.',
    ...
    ky: {
      ...
      depositAnswer: '«Депозит» бөлүмүнө өтүңүз, эсепти тандаңыз, ID жана сумманы киргизиңиз, андан кийин банкты тандаңыз жана көрсөтмөлөрдү аткарыңыз.',
      withdrawQuestion: 'Кантип чыгаруу?',
      withdrawAnswer: '«Чыгаруу» бөлүмүн ачыңыз, эсеп жана банкты тандаңыз, телефон, сайт кодун көрсөтүңүз жана өтүнүчтү ырастаңыз.',
      ...
      limitsAnswer: 'Эң аз депозит суммасы: 35 сом, эң көп: 500,000 сом. Эң аз чыгаруу суммасы: 100 сом, чектөө жок.',
    ...
    uz: {
      ...
      limitsAnswer: 'Minimal depozit: 35 som, maksimal: 500,000 som. Minimal chiqarish: 100 som, cheklov yo\'q.',
